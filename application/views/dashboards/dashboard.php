      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php $variants = ['primary', 'success', 'info', 'warning', 'danger', 'secondary', 'dark']; ?>

            <?php foreach ($total_categories as $tc): ?>
              <?php $color = $variants[array_rand($variants)]; ?>
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          Rp <?= number_format($tc['total_price'], 0, ',', '.'); ?>
                        </div>
                      </div>
                      <div class="col-auto">
